...
The primary objective of this project was to analyze sales data and build an interactive dashboard that helps identify:
...
| `screenshots/sales-dashboard.png` | Final dashboard preview |
